import type {
  assistant as assistantOrig,
  system as systemOrig,
  user as userOrig,
} from "@openai/agents";
 ...
 */
export const user: typeof userOrig = (
  input,
  options,
) => {
  return {
 ...
 * @returns A message entry.
 */
export const system: typeof systemOrig = (
  input,
  options,
) => {
  return {
 ...
 * @returns A message entry.
 */
export const assistant: typeof assistantOrig = (
  content,
  options,
) => {
  return {
